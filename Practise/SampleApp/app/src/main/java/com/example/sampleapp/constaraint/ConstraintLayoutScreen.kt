package com.example.sampleapp.constaraint
...
fun ConstraintLayoutScreen() {
    ConstraintLayout(
        ...
        Image(
            painterResource(id = R.drawable.ic_bg3),
            contentDescription = "",
            contentScale = ContentScale.FillBounds,
            modifier = Modifier
        ...
        Image(imageVector = Icons.Filled.MailOutline,
            contentDescription = "",
            modifier = Modifier
        ...
        Image(imageVector = Icons.Filled.Check,
            contentDescription = "",
            modifier = Modifier
